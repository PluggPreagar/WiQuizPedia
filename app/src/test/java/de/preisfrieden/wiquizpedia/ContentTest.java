...
public class ContentTest {
    ...
    public void parseTitle(){
        ...
        content = new Content();
        assertEquals("Brasilien", content.parseTitle(msg));
        assertEquals("Brasilien", content.title);
    ...
    public void normaliseContent(String msg) {
    }

    public void extractAndReplaceRef(String msg) {

    }

    private void extractAndReplaceValues(String msg) {

    }

    private void extractAndReplaceTokenByPattern(String msg, String categoryOrId, String pattern) {

    }

    private void extractSentences(String msg) {

    }

    public void getQuery(MainActivity mainActivity){
    ...
    public void normaliseContent() {
        ...
        content = new Content();
        assertEquals(msg2, content.normaliseContent(msg));
